...
def verify_outputs(
    ...
    *,
    ...
    holdout_metrics = Path("artifacts/evals/llm_v2_1/holdout_metrics.json")
    release_status = "candidate_holdout_pending" if artifact_prompt_version == "2.1.0" and not holdout_metrics.exists() else "formal"
    ...
    if write_report:
        ...
        incomplete = (
            ...
            if release_status == "candidate_holdout_pending"
            else "无。"
        )
